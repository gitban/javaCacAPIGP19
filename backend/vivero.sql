...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-07-2024 a las 20:49:13
...
(1, 'Loto', 'Acuifera', 'crece en el agua', 'C:\\fakepath\\agave.jpg', 25, 50, 75, 25),
(2, 'Loto', 'Acuifera', 'crece en el agua', 'C:\\fakepath\\agave.jpg', 25, 50, 75, 25);
...
INSERT INTO `usuarios` (`rol_id`, `created_at`, `id`, `apellido`, `os_id`, `dni`, `clave`, `nombre`, `telefono`) VALUES
(NULL, NULL, 6, 'Perez', NULL, 24271970, 'lapataia', 'Esteban', '2914779973'),
...
(1, NULL, 18, 'Dalgalarrondo', NULL, 24271972, 'lapataia', 'Esteban Alejandro', '2914779973');
